...
const PROVIDER_OPTIONS: ProviderOption[] = [
  ...
  },
  {
    ...
    configFields: [
      ...
      { key: "transfer_scene_job_type", label: "转账报备-岗位类型（可选）", placeholder: "默认：销售顾问", hint: "微信商家转账「佣金报酬」场景必填的转账场景报备信息（info_content），用于微信审核转账用途；留空则使用默认值" },
      { key: "transfer_scene_remark", label: "转账报备-报酬说明（可选）", placeholder: "默认：佣金报酬结算", hint: "微信商家转账「佣金报酬」场景必填的转账场景报备信息（info_content），用于微信审核转账用途；留空则使用默认值" },
    ],
  },
  {
    type: "usdt",
